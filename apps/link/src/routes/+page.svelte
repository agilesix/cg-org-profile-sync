<script lang="ts">
  const routes = [
    { verb: "GET", path: "/link.js", note: "embed loader the host app scripts in" },
    { verb: "GET", path: "/widget", note: "the iframe app itself" },
    { verb: "GET", path: "/api/compare", note: "read every connected profile and diff them" },
    { verb: "POST", path: "/api/sync", note: "fan the selected values out to the chosen targets" },
  ];
</script>
